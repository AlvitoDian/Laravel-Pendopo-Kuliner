            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">{{ $productTransDetails->product->category->name }}
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6"
                                ...
                                <img src="{{ asset('storage/' . $productTransDetails->product->image) }}"
                                    alt="{{ $productTransDetails->product->category->name }}"
                                    class="img-fluid mt-3 mb-3 shadow-lg"
                            ...
                            <div class="col-lg-6">
                                ...
                                <div style="display: inline-block;">{{ $productTransDetails->transaction->user->name }}
                                </div>
                                </p>
